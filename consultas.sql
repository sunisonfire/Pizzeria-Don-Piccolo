...
JOIN pedido pe ON c.id_persona = pe.id_cliente
...
FROM pizza p
JOIN detallepedido dp ON p.id_pizza = dp.id_pizza
...
JOIN domicilio d ON r.id_persona = d.id_repartidor
...
FROM zona z
JOIN domicilio d ON z.id_zona = d.id_zona
